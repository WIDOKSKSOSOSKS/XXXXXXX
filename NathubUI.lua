...
NatHub["2"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["4"]["BackgroundColor3"] = Color3.fromRGB(25, 25, 25);
...
NatHub["a"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["13"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["14"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["26"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["27"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["29"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["32"]["Color"] = Color3.fromRGB(80,20,20);


-- NatHub.Window.Tabs
NatHub["33"] = Instance.new("Frame", NatHub["2"]);
NatHub["33"]["BorderSizePixel"] = 0;
NatHub["33"]["BackgroundColor3"] = Color3.fromRGB(25, 25, 25);
...
NatHub["35"]["BackgroundColor3"] = Color3.fromRGB(25, 25, 25);
...
NatHub["36"]["BackgroundColor3"] = Color3.fromRGB(25, 25, 25);
...
NatHub["37"]["TextColor3"] = Color3.fromRGB(150, 150, 150);
...
NatHub["43"]["ScrollBarImageColor3"] = Color3.fromRGB(100, 100, 100);
...
NatHub["4c"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["54"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(139, 0, 0)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(139, 0, 0)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(220, 20, 60))};


-- NatHub.Templates.Button.Frame.UIGradient
NatHub["55"] = Instance.new("UIGradient", NatHub["4e"]);
NatHub["55"]["Enabled"] = false;
NatHub["55"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(255, 0, 0)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(139, 0, 0)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(255, 0, 0)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(220, 20, 60))};


-- NatHub.Templates.Button.Frame.UIGradient
NatHub["56"] = Instance.new("UIGradient", NatHub["4e"]);
NatHub["56"]["Enabled"] = false;
NatHub["56"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(139, 0, 0)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(255, 0, 0)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(139, 0, 0)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(220, 20, 60))};
...
NatHub["59"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["60"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["67"]["BackgroundColor3"] = Color3.fromRGB(35, 35, 35);
...
NatHub["6b"]["ImageColor3"] = Color3.fromRGB(35, 35, 35);
...
NatHub["6d"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["6e"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub["72"]["TextColor3"] = Color3.fromRGB(200, 200, 200);
...
NatHub["82"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["8c"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["93"]["Color"] = Color3.fromRGB(200, 0, 0);
...
NatHub["9a"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["a3"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["a7"]["PlaceholderColor3"] = Color3.fromRGB(120, 120, 120);
...
NatHub["a9"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["b0"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["bd"]["ScrollBarImageColor3"] = Color3.fromRGB(100, 100, 100);
...
NatHub["c0"]["ScrollBarImageColor3"] = Color3.fromRGB(100, 100, 100);
...
NatHub["c3"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["cf"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["d6"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["d7"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["ea"]["BackgroundColor3"] = Color3.fromRGB(25, 25, 25);
...
NatHub["fd"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 30);
...
NatHub["105"]["BackgroundColor3"] = Color3.fromRGB(20, 20, 20);
...
NatHub_MODULES[NatHub["3e"]] = {
	Closure = function()
			...
			function Window:Tab(data)
				...
				function Tab:Button(data)
					...
					newButton.MouseEnter:Connect(function()
						if not ButtonData.Locked then
							Tween(newButton.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
						end
					end)

					newButton.MouseLeave:Connect(function()
						if not ButtonData.Locked then
							Tween(newButton.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
					...
					function Button:Unlock()
						...
						Tween(newButton, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)
						Tween(newButton.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						Tween(newButton.Frame.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newButton.Frame.Title.ClickIcon, {ImageColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newButton.Frame.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
				...
				function Tab:Toggle(data)
					...
					newToggle.Title.Fill.MouseEnter:Connect(function()
						if not Toggle.Locked then
							Tween(newToggle.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
						end
					end)

					newToggle.Title.Fill.MouseLeave:Connect(function()
						if not Toggle.Locked then
							Tween(newToggle.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)

							newToggle.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
							Tween(newToggle.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
							Tween(newToggle.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						end
					end)
					...
					function Toggle:Unlock()
						Toggle.Locked = false
						Tween(newToggle, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)
						Tween(newToggle.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						Tween(newToggle.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newToggle.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
				...
				function Tab:Slider(data)
					...
					if perc % 1 == 0 then
						...
						if not Hovering then
							Tween(newSlider.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						end
					end
					...
					Trigger.MouseEnter:Connect(function()
						...
						if not Slider.Locked then
							Tween(newSlider.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
						end
					end)
					...
					function Slider:Unlock()
						...
						Tween(newSlider, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)
						Tween(newSlider.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						Tween(newSlider.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newSlider.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)

						Tween(newSlider.SliderFrame.Frame.Slider.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
				...
				function Tab:Input(data)
					...
					newInput.BoxFrame.Frame.TextBox.MouseEnter:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
						end
					end)

					newInput.BoxFrame.Frame.TextBox.MouseLeave:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						end
					end)
					...
					newInput.BoxFrame.Frame.TextBox.Focused:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
							Tween(newInput.BoxFrame.Frame.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
						end
					end)

					newInput.BoxFrame.Frame.TextBox.FocusLost:Connect(function()
						if not Input.Locked then
							Tween(newInput.BoxFrame.Frame.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
					...
					function Input:Unlock()
						...
						Tween(newInput.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						Tween(newInput, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)

						Tween(newInput.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newInput.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)

						Tween(newInput.BoxFrame.Frame, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)
						Tween(newInput.BoxFrame.Frame.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
				...
				function Tab:Dropdown(data)
						...
						if not multi then
							...
							for _,otherButton in dropdownFolder.DropdownItems:GetChildren() do
								if otherButton:IsA("GuiButton") and otherButton.Name ~= newvalue then
									Tween(otherButton.Frame.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
									Tween(otherButton.Frame.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
									Tween(otherButton.Frame, {BackgroundTransparency = 1}, TweenConfigs.Global)
									Tween(otherButton.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
								end
							end
							...
							Tween(targetButton.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
							...
							Tween(targetbuttonSearch.UIStroke, {Color = Color3.fromRGB(246, 10, 49)}, TweenConfigs.Global)
						...
						elseif multi then
							for _, newSelected in newvalue do
								...
								local idx = table.find(selected, newSelected) if idx then
									...
									Tween(targetButton.Frame.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
									Tween(targetButton.Frame.Description, {TextColor3 = Color3.fromRGB(255, 255, 2555)}, TweenConfigs.Global)
									Tween(targetButton.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
									Tween(targetButton.Frame, {BackgroundTransparency = 1}, TweenConfigs.Global)

									Tween(targetbuttonSearch.Frame.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
									Tween(targetbuttonSearch.Frame.Description, {TextColor3 = Color3.fromRGB(255, 255, 2555)}, TweenConfigs.Global)
									Tween(targetbuttonSearch.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						...
						if not Dropdown.Multi then
							...
							for _, buttonName in buttonList do
								...
								if selected == buttonName then
									...
									newDropdownButton.UIStroke.Color = Color3.fromRGB(246, 10, 49)
									...
									newDropdownButtonSearch.UIStroke.Color = Color3.fromRGB(246, 10, 49)
					...
					function Dropdown:Unlock()
						...
						Tween(newDropdown.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						Tween(newDropdown, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)

						Tween(newDropdown.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newDropdown.Description, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
						Tween(newDropdown.Title.ClickIcon, {ImageColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)

						Tween(newDropdown.Title.BoxFrame.Trigger, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}, TweenConfigs.Global)
						Tween(newDropdown.Title.BoxFrame.Trigger.UIStroke, {Color = Color3.fromRGB(80, 20, 20)}, TweenConfigs.Global)
						Tween(newDropdown.Title.BoxFrame.Trigger.Title, {TextColor3 = Color3.fromRGB(255, 255, 255)}, TweenConfigs.Global)
      ...
      function Window:OnHide(func)
        if type(func) ~= "function" then return end
        OnCloseCallback = func or OnCloseCallback -- i need this only srry
      end
      function Window:OnDestroy(func)
        if type(func) ~= "function" then return end
        OnDestroyCallback = func or OnDestroyCallback -- Of course this shit to
      end
			...
			newFloatingIcon.Open.MouseButton1Click:Connect(function()
				if not timeout then
					...
					if type(OnOpenCallback) == "function" then
					  task.spawn(OnOpenCallback)
					end
				end
			end)
					...
					Buttons = {
						...
						},
						{
							...
							Callback = function()
								...
								if type(OnDestroyCallback) == "function" then
								  task.spawn(OnDestroyCallback)
								end
							end,
						}
					}
