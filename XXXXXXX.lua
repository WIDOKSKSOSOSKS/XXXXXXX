			...
			function Window:Tab(data)
				...
				function Tab:Button(data)
					...
					newButton.MouseLeave:Connect(function()
						if not ButtonData.Locked then
							Tween(newButton.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
				...
				function Tab:Toggle(data)
					...
					newToggle.Title.Fill.MouseLeave:Connect(function()
						if not Toggle.Locked then
							Tween(newToggle.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
				...
				function Tab:Slider(data)
					...
					if perc % 1 == 0 then
						...
						if not Hovering then
							Tween(newSlider.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
						end
					end
					...
					function Slider:Unlock()
						...
						Tween(newSlider.SliderFrame.Frame.Slider.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
				...
				function Tab:Input(data)
					...
					newInput.BoxFrame.Frame.TextBox.MouseLeave:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
						end
					end)
					...
					newInput.BoxFrame.Frame.TextBox.FocusLost:Connect(function()
						if not Input.Locked then
							Tween(newInput.BoxFrame.Frame.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
				...
				function Tab:Dropdown(data)
						...
						if not multi then
							...
							for _,otherButton in dropdownFolder.DropdownItems:GetChildren() do
								if otherButton:IsA("GuiButton") and otherButton.Name ~= newvalue then
									...
									Tween(otherButton.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
								end
							end
						...
						elseif multi then
							for _, newSelected in newvalue do
								...
								local idx = table.find(selected, newSelected) if idx then
									...
									Tween(targetButton.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
									...
									Tween(targetbuttonSearch.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
					...
					function Dropdown:Unlock()
						...
						Tween(newDropdown.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
						...
						Tween(newDropdown.Title.BoxFrame.Trigger.UIStroke, {Color = Color3.fromRGB(80, 80, 20)}, TweenConfigs.Global)
